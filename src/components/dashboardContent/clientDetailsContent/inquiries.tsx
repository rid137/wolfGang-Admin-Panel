...
import { letterCreationInquiryTableColumns } from '../../common/reactTableColumn';
...
const Inquiries: React.FC<InquiriesProps> = ({InqAcc}) => {
    ...
    const memoizedInquiryData = useMemo(() => InqAcc, [InqAcc])
  ...
  return (
    <section>
        ...
        <UserTable data={memoizedInquiryData ?? []} columns={letterCreationInquiryTableColumns} />
